---
title: "Symmetry elements and symmetry operations"
author: ["Easton"]
date: 2026-07-16
tags: ["csr"]
draft: false
...
-   **Principal axis** occurs when one axis of symmetry has higher value of \\(n\\) than all other axes
...
-   Three types of mirror planes: \\(\sigma\_h\\), \\(\sigma\_v\\), \\(\sigma\_d\\)
    ...
    -   Measured with respect to principal axis (i. e. horizontal = perpendicular to axis)
    -   Vertical vs dihedral:
        -   Dihedral plane **bisects** the angle between two \\(C\_n\\) axes
...
-   Denoted \\(S\_n\\), referred to as \\(n\\)-fold rotation axis
    -   Rotation by \\(\frac{360}{n}\\) followed by reflection about plane **perpendicular** to rotation axis
